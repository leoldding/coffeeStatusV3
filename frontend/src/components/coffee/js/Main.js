...
function CoffeeMain() {
    ...
    return (
        <div className={"h-full"}>
            ...
            <div className={`h-56 w-56 md:h-96 md:w-96 border-4 border-[#2C2C2C] border-solid rounded-full mx-auto mt-24 mb-4 flex flex-column justify-center items-center ${colors[status]}`}>
            ...
            <div className={"relative"}>
                ...
                <div data-testid={"infoCard"} className={`absolute md:text-2xl bg-[#D7C5B4] border-2 border-[#2C2C2C] border-solid rounded shadow-[0.25rem_0.25rem_0.15rem_0.05rem_rgba(44,44,44,0.3)] p-2 top-8 right-12 md:-top-28 w-fit transition duration-200 ${hidden}`}>
                    <div>Green = "Yes"</div>
